...
namespace pz_32
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrivatePhone prf = new PrivatePhone("+7", 922, "9248712", "корпоративный","Иван,Василий,Антон,Павел,Фёдеор");
            PrivatePhone prf1 = new PrivatePhone("+8", 951, "6723945", "корпоративный", "Иван,Павел");
            ph.GetPhoneNumber();
            ph1.GetPhoneNumber();
            ph2.GetPhoneNumber();
            ph3.GetPhoneNumber();
